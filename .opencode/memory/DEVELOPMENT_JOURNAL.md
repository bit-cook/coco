...
The `v0.7.1` release candidate was cut from merged TOOL-001 main commit `aa7fd596bc8539a7e57c0c5872e27915c0befcd3`. `verify-main` moved from the offline `coco-ci-local` runner to pinned Node `22.19.0` on `ubuntu-24.04`; the integrity job remains isolated on `coco-upstream`. Version/release focused contracts pass `68/68`, typechecks pass, core `676/676`, integrity `39/39`, closure `172`, scanner clean, package `2/2`, runtime probe `21,368`, and Node `22.19.0` startup performance pass. Release workflow lifecycle evidence remains pending the immutable tag.
