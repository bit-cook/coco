...
The missing Pi lifecycle correlation contract is tracked at `https://github.com/earendil-works/pi/issues/8380`. The request asks for one shared request ID, attempt metadata, and terminal events for success, error, stream failure, and abort. No CoCo private state or credential information was included.
