...
```bash
curl -fsSLO https://github.com/bit-cook/coco/releases/download/v0.7.0/install.sh
COCO_VERSION=0.7.0 bash install.sh
```
...
```bash
sha256sum --check coco-0.7.0-offline-linux-x64.zip.sha256
```
