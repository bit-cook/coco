...
```bash
curl -fsSLO https://github.com/bit-cook/coco/releases/download/v0.3.3/install.sh
COCO_VERSION=0.3.3 bash install.sh
```
...
```bash
sha256sum --check coco-0.3.3-offline-linux-x64.zip.sha256
```
