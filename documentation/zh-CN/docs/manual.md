...
```bash
curl -fsSLO https://github.com/bit-cook/coco/releases/download/v0.3.9/install.sh
COCO_VERSION=0.3.9 bash install.sh
```
...
```bash
sha256sum --check coco-0.3.9-offline-linux-x64.zip.sha256
```
