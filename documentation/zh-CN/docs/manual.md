...
```bash
curl -fsSLO https://github.com/bit-cook/coco/releases/download/v0.3.10/install.sh
COCO_VERSION=0.3.10 bash install.sh
```
...
```bash
sha256sum --check coco-0.3.10-offline-linux-x64.zip.sha256
```
