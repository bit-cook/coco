...
```bash
curl -fsSLO https://github.com/bit-cook/coco/releases/download/v0.4.2/install.sh
COCO_VERSION=0.4.2 bash install.sh
```
...
```bash
sha256sum --check coco-0.4.2-offline-linux-x64.zip.sha256
```
