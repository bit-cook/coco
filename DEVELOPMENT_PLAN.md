...
ORCH-001 staged foundations, service facade, Control routes, runner inbox priority selection, child admission budgets, terminal lineage synchronization, and actual usage aggregation are now present. Focused ORCH tests pass; the frozen batch passes core `675/675`, closure `172`, scanner clean, package `2/2`, and runtime probe `21,365`. Parent-failure policy and full child diagnostics remain.
