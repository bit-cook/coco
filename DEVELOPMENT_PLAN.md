...
ORCH-001 staged foundations, service facade, Control routes, runner inbox priority selection, child admission budgets, and child terminal lineage synchronization are now present. Focused ORCH tests pass; the frozen batch passes core `674/674`, closure `172`, scanner clean, package `2/2`, and runtime probe `21,365`. Aggregate actual-usage accounting remains.
