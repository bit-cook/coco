...
ORCH-001 staged foundations, service facade, Control routes, and runner inbox priority selection are now present: durable inbox with priority/admission, bounded continuation policy, and supervisor-owned parent/child lineage. Focused ORCH tests pass; the frozen batch passes core `668/668`, closure `172`, scanner clean, package `2/2`, and runtime probe `21,363`. Child spawning and budget aggregation remain.
