...
for (const api of ["spawn", "spawnSync", "execFile", "execFileSync", "exec", "execSync", "fork"]) {
  test(`Given hostile ${api} child options, when its child catches TCP, then authoritative evidence rejects`, async () => {
...
test("Given callback and sync child APIs with no network, when guarded, then they retain valid execution semantics", async () => {
