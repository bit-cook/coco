...
test("comments, strings, longer names, and wrong containers never satisfy exact methods", async () => {
  ...
  try {
    ...
    const files = ["dist/core/extensions/types.d.ts","dist/core/extensions/api.js","dist/core/model-runtime.d.ts","dist/core/model-runtime.js","dist/core/settings-manager.d.ts","dist/core/settings-manager.js","dist/core/agent-session.d.ts","dist/core/agent-session.js"];
