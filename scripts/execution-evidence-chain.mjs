...
export function verifyExecutionEvidenceChain({ preflight, binding, matrixEvidence, descriptor, cases, receipt, attestation, discovery } = {}) {
  ...
  return Object.freeze({ adapterSha256: discovered.adapterSha256, attestationSha256: adapter.attestationSha256, matrix: matrix.status, providerId: matrix.providerId, receiptSha256, requestSha256: bindingResult.requestSha256, schemaVersion: 1, status: "verified" });
}
